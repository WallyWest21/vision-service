...
public class RuntimeSettingsDto
{
    ...
    public RateLimitSettingsDto? RateLimit
    {
        get; set;
    }

    /// <summary>Response cache settings.</summary>
    public CacheSettingsDto? Cache
    {
        get; set;
    }

    /// <summary>Performance tuning settings.</summary>
    public PerformanceSettingsDto? Performance
    {
        get; set;
    }

    /// <summary>YOLO backend settings.</summary>
    public YoloSettingsDto? Yolo
    {
        get; set;
    }

    /// <summary>Qwen-VL backend settings.</summary>
    public QwenVlSettingsDto? QwenVl
    {
        get; set;
    }

    /// <summary>Storage settings.</summary>
    public StorageSettingsDto? Storage
    {
        get; set;
    }
}
...
public class PerformanceSettingsDto
{
    ...
    public int? ImageCleanupIntervalHours
    {
        get; set;
    }

    /// <summary>Maximum concurrent AI backend requests (0 = unlimited).</summary>
    public int? MaxConcurrentAiRequests
    {
        get; set;
    }
}
