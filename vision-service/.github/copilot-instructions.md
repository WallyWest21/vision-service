...
## Project Context
This is a .NET 8 camera vision microservice that orchestrates YOLOv8 and Qwen-VL AI backends running in Docker containers. The implementation plan is in `docs/service-plan.md`.
